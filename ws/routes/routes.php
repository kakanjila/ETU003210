...
// // Types de prêt
// Flight::route('GET /types-pret', ['TypesPretController', 'getAll']);
// Flight::route('GET /types-pret/@id', ['TypesPretController', 'getById']);
// Flight::route('GET /etablissements/@id_etablissement/types-pret', ['TypesPretController', 'getByEtablissement']);
// Flight::route('POST /types-pret', ['TypesPretController', 'create']);
// Flight::route('PUT /types-pret/@id', ['TypesPretController', 'update']);
// Flight::route('DELETE /types-pret/@id', ['TypesPretController', 'delete']);
